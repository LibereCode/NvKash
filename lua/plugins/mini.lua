...
return { -- Collection of various small independent plugins/modules
   ...
   config = function()
      ...
      require('mini.ai').setup { n_lines = 723 } -- NOTE: AI
      ...
      require('mini.surround').setup { -- NOTE: SURROUND
      ...
      -- local statusline = require 'mini.statusline' -- NOTE: STATUSLINE
      ...
      -- require('mini.starter').setup { -- NOTE: STARTER
      --
      -- }

...
Kickstart Guide:
  ...
  TODO: The       "<leader>?",
      ...
      desc = "Buffer Local Keymaps (which-key)",very first thing you should do is to run the command `:Tutor` in Neovim.
...
require('lazy').setup({
  ...
  --  This is the easiest way to modularize your config. Uncomment the following line and add your plugins to `lua/plugins/*.lua` to get going.
  { import = 'plugins' },
  --
  ...
  --
  -- HACK: Disabling default NvChad plugins
  --  { "foo/bar.nvim",  enabled = false }, -- disable a default nvchad plugin
...
-- import nvchad options|autocmds|mappings -- Moved to respective custom config file
...
-- import Custom options|autocmds|mappings
require 'options'
require 'autocmds'
vim.schedule(function() require 'mappings' end) -- why vim.schedule? idk
